    ...
    <section id="ubicacion" className="bg-[#fff8e7] px-6 py-24 sm:px-8 lg:px-12">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-black text-[#1b1b1b] sm:text-4xl">Estamos en Culiacán y listos para recibirte.</h2>
          <p className="mt-4 text-lg leading-8 text-[#1b1b1b]/70">
            Ven a disfrutar de la mejor propuesta de birria, menú nocturno y eventos con un ambiente cercano y profesional.
          </p>
          ...
          <div className="mt-8 space-y-5 rounded-[24px] border border-[#1b1b1b]/10 bg-white p-8 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#1b1b1b]/70">Culiacán, Sinaloa</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#1b1b1b]/70">Menú nocturno de lunes a sábado y birria de viernes a domingo.</p>
              </div>
            </div>
            <a href="https://maps.google.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#9d0208] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#d00000]">
